    ...
    return (
        <section className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                <h1 className="text-start text-6xl font-semibold text-white mt-5 max-sm:text-5xl">About Me</h1>

                <div className={`${styles.paragraph} max-w-full mt-5 font-Space leading-loose text-white space-y-3 text-lg`}>
                    <p>
